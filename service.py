...
async def post_test(
    request: Request,
    db: Session,
    raw_data: schemas.PostTest,
):
    api_key: str = raw_data.api_key
    from_addr: str = raw_data.from_addr
    to_addr: str = raw_data.to_addr
    subject: str = raw_data.subject
    body: str = raw_data.body
    server: str = raw_data.server
    port: str = raw_data.port
    email: str = raw_data.email
    password: str = raw_data.password
